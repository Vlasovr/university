    ...
    def _print_progress(self, total_size, interval=1.5):
        ...
        while not self.stop_flag:
            ...
            if delta_time >= interval:
                ...
                speed = netbytes.calculate_speed(0, delta_time, delta_bytes)
                received_str = netbytes.human_readable_size(received)
                total_str = netbytes.human_readable_size(total_size)
